...
A sortable, filterable dashboard for comparing **47 proprietary trading firms**
...
- **47 firms** hand-curated into a typed dataset (`data/firms.json`), each with a
...
- **Check the confidence dot first.** Each firm carries a data-confidence rating
  ...
  *(Current dataset: 36 high, 11 medium.)*
